...
| :--------------------------- | :------------------- | :---------------------------------------------------------: | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Milenko Ruben Cayanchi Avila | U202312566           | ![Foto de Milenko](../assets/images/cap1/team/Milenko.jpeg) | **Ingeniería de Software** - Mi nombre es Milenko Rubén Cayanchi Avila, tengo 20 años y actualmente estudio Ingeniería de Software. Me considero una persona proactiva, responsable y con gran interés en la tecnología. Disfruto el desarrollo de software y busco constantemente aprender nuevas herramientas que aporten valor a los proyectos. Mi objetivo es especializarme en desarrollo de software y contribuir en el campo de la salud tecnológica.                                                                                                                                                                                                   |
| Diego Andrés Ávalos Cordova  | U202313922           |   ![Foto de Diego](../assets/images/cap1/team/diego.png)    | **Ingeniería de Software** - Mi nombre es Diego Ávalos, tengo 20 años y actualmente estudio Ingeniería de Software. Me interesa especializarme en Desarrollo FullStack, Ciberseguridad y Hacking Ético. Tengo experiencia usando sistemas operativos GNU/Linux y conocimientos en desarrollo web. También me interesan los temas relacionados con tecnología e inteligencia artificial, por lo que busco investigar y aprender constantemente sobre nuevas herramientas que aporten valor al proyecto.                                                                                                                                                         |
| Jose Gustavo Asto Jacome     | U20241C630           |    ![Foto de Jose](../assets/images/cap1/team/Asto.jpeg)    | **Ingeniería de Software** - Mi nombre es José Asto y actualmente estudio Ingeniería de Software en la UPC. Me interesa especializarme en desarrollo de software, especialmente en Backend, desarrollo Full Stack e Inteligencia Artificial aplicada. Tengo experiencia trabajando con tecnologías como Angular, Vue, Spring Boot, .NET, MySQL y Git, además de conocimientos en arquitectura de software y desarrollo de aplicaciones web. También me interesa aprender constantemente sobre nuevas tecnologías, herramientas y buenas prácticas que me permitan mejorar mis habilidades y aportar soluciones de valor en los proyectos en los que participo. |
| Mauricio Luis Pajés León | u202410093 | ![Foto de Mauricio](../assets/images/cap1/team/Mauricio.jpeg) | **Ingeniería de Software** - Mi nombre es Mauricio Luis Pajés León y estudio Ingeniería de Software en la UPC. Me enfoco en el desarrollo Backend, principalmente con TypeScript y Node.js, integración de APIs, bases de datos y procesamiento de eventos en AWS. También manejo C++, Python, Java con Spring Boot, .NET y Angular, y tengo conocimientos en patrones de software y bases de datos SQL y NoSQL. Me interesa seguir aprendiendo nuevas tecnologías, desarrollar soluciones confiables y trabajar en equipo. |
| Alexther Kamil Diaz Martinez   | u2024123416 |                     ![Foto de kamil](../assets/images/cap1/team/Alexther.jpeg)                      | **Ingeniería de Software**  - Soy Alexther Kamil, estudiante de 6to ciclo de Ingeniería de Software y desarrollador Full Stack. Me destaco por ser un perfil orientado al trabajo en equipo, con una actitud positiva y gran resiliencia frente a los desafíos tecnológicos. Cuento con una sólida base tanto en frontend como en backend, dominando C++, Python, Java, HTML, CSS, JavaScript y SQL. Actualmente, tengo un fuerte interés en la implementación de soluciones de Inteligencia Artificial para optimizar procesos y potenciar proyectos. Soy una persona altamente adaptable, siempre dispuesta a aprender e integrar las tecnologías que cada reto requiera.|
| Arizabal Condori, Jean Niels | U201919096 | ![Foto de Jean Niels](../assets/images/cap1/team/JeanNiels.png) | **Ingeniería de Software** - Soy Jean Niels Arizabal Condori, estudiante de Ingeniería de Software. Me interesa el desarrollo de aplicaciones y la construcción de soluciones digitales orientadas a resolver necesidades reales de los usuarios. Durante el proyecto contribuyo en la revisión, integración y documentación de los artefactos de SafeSpace, fortaleciendo el trabajo colaborativo y la calidad de la solución. |
...
![Lean UX Canvas](../assets/images/cap1/Lean_UX_Canvas.png)
